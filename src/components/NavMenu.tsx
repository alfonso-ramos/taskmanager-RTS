    ...
    return (
        ...
        >
            ...
            <div className="w-full lg:w-56 shrink rounded-xl bg-white p-4 text-sm font-semibold leading-6 text-gray-900 shadow-lg ring-1 ring-gray-900/5">
                ...
                <Link to="/profile" className="block p-2 hover:text-purple-600 transition-colors">
                My profile
                </Link>
                <Link to="/" className="block p-2 hover:text-purple-600 transition-colors">
                My projects
                </Link>
                <button
                className="block p-2 hover:text-red-600 transition-colors"
                type="button"
                onClick={logout}
                >
                Sign out
